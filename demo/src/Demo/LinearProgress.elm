...
view model =
    ...
    , hero =
        [ LinearProgress.determinate LinearProgress.config { progress = 0.5 } ]
    , content =
        [ Html.h3 [ Typography.subtitle1 ] [ text "Determinate" ]
        , LinearProgress.determinate LinearProgress.config { progress = 0.5 }
        ...
        , LinearProgress.indeterminate
            (LinearProgress.config
                |> LinearProgress.setAttributes [ Html.Attributes.dir "rtl" ]
            )
        , Html.h3 [ Typography.subtitle1 ] [ text "Right to Left Localized" ]
        , Html.h4 [ Typography.subtitle1 ] [ text "Determinate" ]
        , LinearProgress.determinate
            (LinearProgress.config
                |> LinearProgress.setAttributes [ Html.Attributes.dir "rtl" ]
            )
            { progress = 0.5 }
        , Html.h4 [ Typography.subtitle1 ] [ text "Buffered" ]
        , LinearProgress.buffered
            (LinearProgress.config
                |> LinearProgress.setAttributes [ Html.Attributes.dir "rtl" ]
            )
            { progress = 0.5, buffered = 0.75 }
        , Html.h4 [ Typography.subtitle1 ] [ text "Indeterminate" ]
        , LinearProgress.indeterminate
            (LinearProgress.config
                |> LinearProgress.setAttributes [ Html.Attributes.dir "rtl" ]
            )
