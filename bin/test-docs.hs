...
trySnippet code tempFile h = do
  ...
  hPutStrLn h "type Interacted = Interacted"
...
writePrelude h = do
  ...
  hPutStrLn h "import Material.Chip.Action as ActionChip"
  ...
  hPutStrLn h "import Material.ChipSet.Action as ActionChipSet"
  hPutStrLn h "import Material.ChipSet.Choice as ChoiceChipSet"
  hPutStrLn h "import Material.ChipSet.Filter as FilterChipSet"
  hPutStrLn h "import Material.ChipSet.Input as InputChipSet"
