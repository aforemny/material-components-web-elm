...
* Add Dialog variants `simple`, `alert` and `confirmation` ([dbd1a75](https://github.com/aforemny/material-components-web-elm/commit/dbd1a75587df24df29b1d573003461e703a99d6a))
* Add Dialog.defaultAction ([a299231](https://github.com/aforemny/material-components-web-elm/commit/a2992315701c2d6caa10e4bb516c367bde12081c))
* Add Dialog.fullscreen variant ([1100a0b](https://github.com/aforemny/material-components-web-elm/commit/1100a0b4b851a76f95cbc21dabacedb2f5186e4f))
* Add Dialog.initialFocus ([918f900](https://github.com/aforemny/material-components-web-elm/commit/918f900de66f78c1b70250f26de553d3e345b88e))
* Add Dialog.setScrimCloses ([2f36bab](https://github.com/aforemny/material-components-web-elm/commit/2f36bab21a3e03bf09e08fd056deb9af8967d9b5))
* Add List.setRipples ([0cf254c](https://github.com/aforemny/material-components-web-elm/commit/0cf254c9d751055f16a3cd64fb920db0ff468507))
* Constrain `Menu.menu` to list items ([e48a41e](https://github.com/aforemny/material-components-web-elm/commit/e48a41ec43855b79a73f3e1d555490951e3e3444))
* Remove LinearProgress.setReverse ([5e59f2f](https://github.com/aforemny/material-components-web-elm/commit/5e59f2ff37d6a1024c6ac3c9ab2e0a1b1e19b107))
* Remove TextField.setFullWidth, TextArea.setFullWidth ([0ee80dd](https://github.com/aforemny/material-components-web-elm/commit/0ee80dde2d299e7d7eec4ef13c7d341fc43f63cc))
* Restrict select items to String content ([6ddcb1e](https://github.com/aforemny/material-components-web-elm/commit/6ddcb1ea38a60c1761c2693e5a2fed7900f4e5e8))
* Ripple.unbounded sets cursor to pointer ([2d83781](https://github.com/aforemny/material-components-web-elm/commit/2d83781372581a4d2a2b46505d24eff65ec3fd4e))
* Update to MDC Web 11.0.0 ([4ba3d99](https://github.com/aforemny/material-components-web-elm/commit/4ba3d996c415ae83b3e9854fa3e3595f97e1ada1))


### Bug Fixes

* Add List.setInteractive ([21f63a4](https://github.com/aforemny/material-components-web-elm/commit/21f63a46b55cc293b7dea33e88293fe183a13a9e))
* Support select without label ([fffa701](https://github.com/aforemny/material-components-web-elm/commit/fffa7016584aeb9b99bba4c6d0650a347095dd99))
